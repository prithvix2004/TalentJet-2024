<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studenthome.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="css-input7" 
                                        PlaceHolder="Enter name to search" Width="400px"></asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:Button ID="Button2" runat="server" 
                                        class="btn btn-light btn-radius btn-brd" Height="60px" onclick="Button1_Click" 
                                        Text="SEARCH" Width="200px" />
                                    <br />
                                    .<br />
                                </td>
                                <td>
                                                        ...
                                                        <td align="center">
                                                            <div class="polaroid5">
                                                                <asp:ImageButton ID="ImageButton3" runat="server" BorderColor="#CC6600" 
                                                                    ...
                                                                    ImageUrl='<%# "student.ashx?id="+Eval("uid") %>' onclick="ImageButton1_Click1" 
                                                                    oncommand="ImageButton1_Command1" Width="240px" />
                                                                <br />
                                                            </div>
                                                        </td>
                                                    </tr>
