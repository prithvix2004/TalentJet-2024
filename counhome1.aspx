<%@ Page Language="C#" AutoEventWireup="true" CodeFile="counhome1.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="coun_quotes.aspx">My Quotes</a></li>
                                                                ...
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-left" rowspan="2">
                                                                            ...
                                                                            <br />
                                                                            <span><asp:Label ID="Label5" runat="server" Font-Size="7pt" 
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <asp:ImageButton ID="ImageButton1" runat="server" BorderColor="#996633" 
                                                                                ...
                                                                                ImageUrl='<%# "student.ashx?id="+Eval("sid") %>' onclick="ImageButton1_Click" 
                                                                                oncommand="ImageButton1_Command" Width="100px" />
                                                                            &nbsp;<asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="11pt" 
                                                                                Font-Underline="False" ForeColor="Black" 
                                                                                Text='<%# DataBinder.Eval(Container.DataItem,"sname") %>'></asp:Label>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
