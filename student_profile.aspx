<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_profile.aspx.cs" Inherits="BLANK" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active"  href="student_profile.aspx">Profile</a></li>
                        ...
                        <table class="w-100">
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td colspan="3">
                                    This is your TALENTJET profile at the time of your registration ,You can edit it 
                                    with new valid details<br />
                                    <br />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="Button3" runat="server" 
                                        class="btn btn-light btn-radius btn-brd" Height="60px" onclick="Button51_Click" 
                                        Text="Change Photo" Width="400px" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
