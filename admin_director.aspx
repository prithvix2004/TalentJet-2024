<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_director.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active" href="admin_director.aspx">Directors Profile</a></li>
            ...
            <div class="">
                ...
                <td><asp:Panel ID="Panel1" runat="server" BorderColor="" BorderStyle="Solid" 
                    ...
                    <br /><table width=1150><tr><td align=center><h1 style="font-size: xx-large; text-align: center;">
                        Directors Profile</h1></td></tr></table>
                <p class="style1">
                    ----------------------------------------------------------------------</p> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DataList ID="DataList1" runat="server" CellPadding="10" 
                                        ...
                                        <ItemTemplate>
                                            <asp:Panel ID="Panel5" runat="server" Width="245px" Height=350>
                                                <table width="125">
                                                    <tr>
                                                        <td align="center">
                                                            <div class="polaroid5">
                                                                ...
                                                                <asp:LinkButton ID="LinkButton1" runat="server" 
                                                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem,"cid") %>' 
                                                                    ForeColor="#FF3300" onclick="LinkButton1_Click1" 
                                                                    oncommand="LinkButton1_Command1" Text='<%# "DELETE" %>'></asp:LinkButton>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
