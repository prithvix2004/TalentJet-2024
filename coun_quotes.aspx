<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coun_quotes.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="coun_add_quotes.aspx">Add Quotes</a></li>
                        <li><a class="active" href="coun_quotes.aspx">My Quotes</a></li>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-center">
                                                                            ...
                                                                            <p><span><span style="font-size: small">
                                                                                <asp:Label ID="Label7" runat="server" Font-Bold="False" Font-Size="XX-Large" 
                                                                                    ForeColor="#FF6600" Text="&quot;"></asp:Label>
                                                                                </span></span><asp:Label ID="Label6" runat="server" Font-Bold="False" Font-Size="12pt" 
                                                                                ForeColor="Black" Text='<%# DataBinder.Eval(Container.DataItem,"cont") %>'></asp:Label>
                                                                                <span><span style="font-size: small">
                                                                                <asp:Label ID="Label8" runat="server" Font-Bold="False" Font-Size="XX-Large" 
                                                                                    ForeColor="#FF6600" Text="&quot;"></asp:Label>
                                                                                </span></span></p>
                                                                            <br />
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton2" runat="server" 
                                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"qid") %>' 
                                                                                onclick="LinkButton1_Click" oncommand="LinkButton1_Command" 
                                                                                Text='<%# "Delete" %>' ForeColor="#FF3300"></asp:LinkButton>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
