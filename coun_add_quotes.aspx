<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coun_add_quotes.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active" href="coun_add_quotes.aspx">Add Quotes</a></li>
            ...
            <div class="">
                ...
                <td><asp:Panel ID="Panel1" runat="server" BorderColor="" BorderStyle="Solid" 
                    ...
                    <br /><table width=1150><tr><td align=center><h1 style="font-size: xx-large; text-align: center;">
                        Post New Quotes</h1></td></tr></table>
                <p class="style1">
                    ----------------------------------------------------------------------</p> 
                    <div class="">
                        <table class="">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TextBox2" runat="server" CssClass="css-input7" 
                                        PlaceHolder="Quotes Title" Width="600px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td>
                                    <asp:TextBox ID="TextBox3" runat="server" CssClass="css-input7" Height="100px" 
                                        PlaceHolder="Quotes Content" TextMode="MultiLine" Width="600px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
