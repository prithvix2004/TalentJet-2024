<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coun_profile.aspx.cs" Inherits="BLANK" %>
                        ...
                        <table class="">
                            ...
                            <tr>
                                ...
                                <td colspan="3" align=center>
                                    ...
                                    <asp:Button ID="Button2" runat="server" 
                                        class="btn btn-light btn-radius btn-brd" Height="60px" onclick="Button8_Click" 
                                        Text="CHANGE PHOTOS" Width="400px" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td align=left>
                                    <span class="style2">Contact Number*</span><asp:RegularExpressionValidator 
                                        ID="RegularExpressionValidator6" runat="server" ControlToValidate="TextBox2" 
                                        ErrorMessage="Invalid Phone Number" ForeColor="#CC0000" 
                                        ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td align=left>
                                    <span class="style2">Emailid*</span><asp:RegularExpressionValidator 
                                        ID="RegularExpressionValidator12" runat="server" ControlToValidate="TextBox5" 
                                        ErrorMessage="Invalid emailid" ForeColor="#CC0000" 
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <asp:Button ID="Button1" runat="server" 
                                        class="btn btn-light btn-radius btn-brd" Height="60px" onclick="Button4_Click" 
                                        Text="EDIT PROFILE" Width="400px" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
