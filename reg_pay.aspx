<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reg_pay.aspx.cs" Inherits="BLANK" %>
                        ...
                        <table class="w-100">
                            <tr>
                                ...
                                <td colspan="3" align=center>
                                    ...
                                    <br />
                                    Your Account has been successfully created.you can pay the registration fee of 
                                    Rs 2000 /- and login </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="TextBox10" runat="server" CssClass="css-input7" 
                                                        PlaceHolder="Card Number" Width="400px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    &nbsp;</td>
                                                <td>
                                                    <asp:TextBox ID="TextBox11" runat="server" CssClass="css-input7" 
                                                        PlaceHolder="CVV Number" TextMode="Password" Width="400px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="TextBox12" runat="server" CssClass="css-input7" 
                                                        PlaceHolder="Card Expiery Date" Width="400px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    &nbsp;</td>
                                                <td>
                                                    <asp:TextBox ID="TextBox13" runat="server" CssClass="css-input7" 
                                                        PlaceHolder="Card Holder Name" Width="400px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <asp:Label ID="Label3" runat="server" ForeColor="Red" 
                                                        Text="Invalid Card Details"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:Button ID="Button3" runat="server" 
                                                        class="btn btn-light btn-radius btn-brd" Height="60px" onclick="Button12_Click" 
                                                        Text="PAY NOW" Width="400px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
