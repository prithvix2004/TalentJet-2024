...
public partial class BLANK : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string ff1 = "u102";
        c.Open();
        String s11a = "select * from reg where uid='" + ff.ToString() + "'";
        ...
        //string s11 = "select * from message where sid='"+ff1.ToString()+"' and cid='"+ff.ToString()+"'";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
        ...
        string s113 = "select * from message where sid='" + ff1.ToString() + "' and cid='" + ff.ToString() + "'";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
        ...
        string s1133 = "select * from message where sid='" + ff1.ToString() + "' and cid='" + ff.ToString() + "'";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sss = "insert into message values('" + s2.ToString() + "','" + Session["sid"].ToString() + "','" + Session["cid3"].ToString() + "','" + TextBox8.Text + "','" + System.DateTime.Today.ToString("dd/MM/yyyy") + "','" + reply.ToString() + "','" + Label4.Text + "')";
