<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coun_messages.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a   class="active" href="coun_messages.aspx">Messages</a></li>
            ...
            <div class="">
                ...
                <td><asp:Panel ID="Panel1" runat="server" BorderColor="" BorderStyle="Solid" 
                    ...
                    <br /><table width=1150><tr><td align=center><h1 style="font-size: xx-large; text-align: center;">
                        Latest Messages</h1></td></tr></table>
                <p class="style1">
                    ----------------------------------------------------------------------</p> 
                    <div class="">
                        <table class="">
                                                            ...
                                                            <td>
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td class="text-left" rowspan="2" align=center>
                                                                            <span>
                                                                            <asp:ImageButton ID="ImageButton1" runat="server" BorderColor="#996633" 
                                                                                BorderStyle="Solid" BorderWidth="1px" 
                                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"sid") %>' 
                                                                                CssClass="imageb" Height="100px" 
                                                                                ImageUrl='<%# "counselor.ashx?id="+Eval("sid") %>' onclick="ImageButton1_Click" 
                                                                                oncommand="ImageButton1_Command" Width="100px" />
                                                                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="11pt" 
                                                                                Font-Underline="False" ForeColor="Black" 
                                                                                Text='<%# DataBinder.Eval(Container.DataItem,"sname") %>' Width="200px"></asp:Label>
                                                                            </span>
                                                                        </td>
                                                                        ...
                                                                        <td rowspan="2">
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:LinkButton 
                                                                                ...
                                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"mid") %>' 
                                                                                onclick="LinkButton1_Click" oncommand="LinkButton1_Command" 
                                                                                Text='<%# "Send Reply" %>'></asp:LinkButton>
                                                                        </td>
                                                                    </tr>
