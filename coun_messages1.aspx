<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coun_messages1.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
                    ...
                    <div class="">
                        <table class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td colspan="3" style="color: #FF6600">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Message :
                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Medium" 
                                        ForeColor="#FF6600" Text="Label"></asp:Label>
                                    <br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="Label8" runat="server" Font-Size="Small" Text="Label"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <br />
                                </td>
                                <td>
