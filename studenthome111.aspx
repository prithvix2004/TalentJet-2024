<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studenthome111.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        <li><a class="active" href="studenthome111.aspx">Home</a></li>
                        <li><a href="student_messages.aspx">Messages</a></li>
                    
                     
                        <li><a href="student_profile.aspx">My Profile</a></li>
	...
	<div id="services" class="">
        <div class="">
            <div class="">
                ...
                <p class="text-center">
                   Hai dear kid,you are welcome to the world of solutions,Please select your counsellor and free to send message</p> 
                    <p class="style1">
                        ----------------------------------------------------------------------</p>
                                                        ...
                                                        <td align="center">
                                                            <div class="polaroid5">
                                                                <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                                    ...
                                                                    CssClass="imageb" Height="140px" 
                                                                    ImageUrl='<%# "counselor.ashx?id="+Eval("cid") %>' 
                                                                    onclick="ImageButton1_Click1" oncommand="ImageButton1_Command1" Width="140px" />
                                                                <br />
                                                                <asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="#FF6600" 
                                                                    Text='<%# DataBinder.Eval(Container.DataItem,"name") %>'></asp:Label>
                                                                <br />
                                                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" 
                                                                    ForeColor="Black" Text='<%# DataBinder.Eval(Container.DataItem,"poition") %>'></asp:Label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr><td>..</td></tr>
