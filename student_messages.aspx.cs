...
public partial class BLANK : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string s11 = "select * from message where sid='"+Session["diid"].ToString()+"'";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
    ...
    protected void LinkButton1_Command(object sender, CommandEventArgs e)
    {
        ...
        string sdw = "delete from message where mid='" + e.CommandArgument.ToString() + "'";// where aid='" + Session["aid"].ToString() + "'";// where pwd='" + f.ToString() + "' and pwd='" + TextBox1.Text + "' ";
