<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_view_quotes.aspx.cs" Inherits="BLANK" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="admin_add_counselor.aspx">Add Counselor</a></li>
                        <li><a href="admin_view_student.aspx">Students List</a></li>
                        <li><a  class="active" href="admin_view_quotes.aspx">Quotes</a></li>
            ...
            <div class="">
                ...
                <td><asp:Panel ID="Panel1" runat="server" BorderColor="" BorderStyle="Solid" 
                    ...
                    <br /><table width=1150><tr><td align=center><h1 style="font-size: xx-large; text-align: center;">
                        Latest Quotes by our Counselors</h1></td></tr></table>
                <p class="style1">
                    ----------------------------------------------------------------------</p> 
                    <div class="">
                        <table class="">
                                                                ...
                                                                <table class="nav-justified">
                                                                    ...
                                                                    <tr>
                                                                        <td align=center>
                                                                            ...
                                                                            <br />
                                                                            <span style="font-size: small">
                                                                            <p style="font-size: xx-large">&quot; <asp:Label ID="Label6" runat="server" 
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton2" runat="server" 
                                                                                ...
                                                                                Text='<%# "Delete Quote" %>' ForeColor="#FF3300"></asp:LinkButton>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
