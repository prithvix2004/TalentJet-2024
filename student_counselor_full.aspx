<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_counselor_full.aspx.cs" Inherits="BLANK" %>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                   <ul class="nav navbar-nav navbar-right">
                        <li><a class="active" href="studenthome.aspx">Home</a></li>
                                            ...
                                            <td align="center">
                                                <div class="polaroid5">
                                                    ...
                                                    <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                        BorderStyle="Solid" BorderWidth="1px" CommandArgument="" CssClass="imageb" 
                                                        Height="140px" ImageUrl="" onclick="ImageButton1_Click1" 
                                                        oncommand="ImageButton1_Command1" Width="140px" />
                                                    <br />
                                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="#FF6600"></asp:Label>
                                                    <br />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:ImageButton ID="ImageButton4" runat="server" CssClass="imageb" 
                                                    Height="270px" Width="400px" onclick="ImageButton4_Click" />
                                            </td>
                                            <td>
                                                &nbsp;</td>
                                            <td>
