...
public partial class BLANK : System.Web.UI.Page
{
    ...
    {
        c.Open();
        String s = "select * from admin";// where uname='" + TextBox7.Text + "'and pwd='" + TextBox8.Text + "'";
        ...
        if (r.Read() == true)
        {
            ...
            if (TextBox2.Text == r["pwd"].ToString())
            {
                ...
                string sdw = "update admin set pwd='" + TextBox5.Text + "'";// where aid='" + Session["aid"].ToString() + "'";// where pwd='" + f.ToString() + "' and pwd='" + TextBox1.Text + "' ";
